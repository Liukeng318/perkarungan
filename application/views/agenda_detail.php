...
<body>
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>PROFIL</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li><a href="<?= base_url("lambang") ?>">LAMBANG LEMBAGA</a></li>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="description-blocks">
                                                    ...
                                                    ?>
                                                        ...
                                                        <br>
                                                        <?php
                                                                $query = $this->db->query("SELECT LENGTH(image) AS panjang FROM pengumuman WHERE id=?", array($link['id']));

                                                                if ($query->num_rows() > 0) {
                                                                    $lampiran = $query->row()->panjang;
                                                                } else {
                                                                    // Handle jika query tidak mengembalikan hasil
                                                                    $lampiran = null; // atau berikan nilai default sesuai kebutuhan
                                                                }
                                                                if ($lampiran > 0) {
                                                        ?>
    ...
    <footer id="footer">
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span><?= ucwords($this->db->get("profile")->row()->nama); ?></span></strong>. AVIGMAN JAGAD SAMAGRAM
            </div>
            <div class="credits">
                Designed by <a href="https://tinyurl.com/4s4r47zp" target="_blank">LUKENG</a>
            </div>
        </div>
    </footer>
